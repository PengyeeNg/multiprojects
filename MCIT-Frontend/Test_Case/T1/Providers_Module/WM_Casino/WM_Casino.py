...
class ProvidersWMModule(Base_Setup.BSetup):
    ...
    def test_TC_Providers_WM_01_Enter_Game_01(self):
        ...
        for j in range(10):
            wait_page_load = EC.presence_of_element_located((By.XPATH, "/html/body/div/div/div/div[2]/div[2]/div/div[2]/ul/li["+str(ProvidersData.loopranwm)+"]/a/p"))
            WebDriverWait(self.driver, 10).until(wait_page_load)
        game_title = self.driver.find_element_by_xpath("/html/body/div/div/div/div[2]/div[2]/div/div[2]/ul/li["+str(ProvidersData.loopranwm)+"]/a/p").text
        print("<li>" + "Click on WM Casino Game in the list: " + game_title + "</li>" + "<br>")
        games = self.driver.find_element_by_xpath("/html/body/div/div/div/div[2]/div[2]/div/div[2]/ul/li["+str(ProvidersData.loopranwm)+"]/a/img").click()
    ...
    def test_TC_Providers_WM_02_Quick_Transfer_01(self):
        ...
        game_title = self.driver.find_element_by_xpath("/html/body/div/div/div/div[2]/div[2]/div/div[2]/ul/li[" + str(ProvidersData.loopranwm) + "]/a/p").text
        print("<li>" + "Click on WM Casino Game in the list: " + game_title + "</li>" + "<br>")
        wait_page_load = EC.element_to_be_clickable((By.XPATH, "/html/body/div/div/div/div[2]/div[2]/div/div[2]/ul/li[" + str(ProvidersData.loopranwm) + "]/a/img"))
        WebDriverWait(self.driver, 10).until(wait_page_load)
        games = self.driver.find_element_by_xpath("/html/body/div/div/div/div[2]/div[2]/div/div[2]/ul/li[" + str(ProvidersData.loopranwm) + "]/a/img").click()
        ProvidersActions.Assert_Quick_Transfer_Modal_Dialog(self)
    ...
    def test_TC_Providers_WM_03_Enter_Game_BeforeLogin(self):
