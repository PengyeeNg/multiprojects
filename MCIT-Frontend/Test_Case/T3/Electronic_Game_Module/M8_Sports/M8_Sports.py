...
class ElectronicGameM8Module(Base_Setup.BSetup):

    def test_TC_M8_01_Navigate_to_M8Sports_BeforeLogin(self):
        print("<b> Expected Results: Login Reminder modal dialog is displayed when accessing M8 Sports game without valid login. </b>" + "<br>")
        ...
        game_position = self.driver.find_element_by_xpath(ElectronicGameElement.m8sports_game)
        actions = ActionChains(self.driver)
        actions.move_to_element(game_position).perform()
        print("<li>" + "Click on a M8 Sports game in the list: " + str(ElectronicGameData.loopranm8) + "</li>" + "<br>")
        wait_page_load = EC.element_to_be_clickable((By.XPATH, ElectronicGameElement.m8sports_game))
        WebDriverWait(self.driver, 10).until(wait_page_load)
        select_game = self.driver.find_element_by_xpath(ElectronicGameElement.m8sports_game).click()
    ...
    def test_TC_M8_04_Quick_Transfer(self):
