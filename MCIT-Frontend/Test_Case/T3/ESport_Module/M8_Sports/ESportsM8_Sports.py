...
class ESportsM8Module(Base_Setup.BSetup):

    def test_TC_ESportsM8_01_Navigate_to_M8Sports_BeforeLogin(self):
        ...
        EsportspageActions.Access_to_M8Sports_Page(self)
        EsportspageActions.Assert_Login_Reminder(self)

    def test_TC_ESportsM8_02_Navigate_to_M8Sports_AfterLogin(self):
    ...
    def test_TC_ESportsM8_03_Enter_Game(self):
    ...
    def test_TC_ESportsM8_04_Quick_Transfer(self):
