...
class SportSBOModule(Base_Setup.BSetup):

    def test_TC_SportSBO_01_Navigate_to_SBO_BeforeLogin(self):
        ...
        ProvidersActions.Access_to_SportSBO_Page(self)
        ProvidersActions.Click_on_SportSBO_Game(self)
        time.sleep(2)
        ProvidersActions.Assert_Login_Page(self)

    def test_TC_SportSBO_02_Navigate_to_SBO_Sports_AfterLogin(self):
    ...
    def test_TC_SportSBO_03_Enter_Game(self):
    ...
    def test_TC_SportSBO_04_Quick_Transfer(self):
