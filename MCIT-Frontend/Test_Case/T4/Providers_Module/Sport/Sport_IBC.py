...
class SportIBCModule(Base_Setup.BSetup):

    def test_TC_SportIBC_01_Navigate_to_IBC_BeforeLogin(self):
        print("<b> Expected Results: Navigate to login page when accessing IBC game without valid login. </b>" + "<br>")
        MainpageActions.Access_to_Mainpage(self)
        MainpageActions.Access_to_Sport(self)
        ProvidersActions.Access_to_SportIBC_Page(self)
        ProvidersActions.Click_on_SportIBC_Game(self)
        time.sleep(2)
        ProvidersActions.Assert_Login_Page(self)

    def test_TC_SportIBC_02_Navigate_to_IBC_AfterLogin(self):
    ...
    def test_TC_SportIBC_03_Enter_Game(self):
    ...
    def test_TC_SportIBC_04_Quick_Transfer(self):
