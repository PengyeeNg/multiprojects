...
class SportM8Module(Base_Setup.BSetup):

    def test_TC_SportM8_01_Navigate_to_M8_Sports_BeforeLogin(self):
        print("<b> Expected Results: Navigate to login page when accessing M8 Sports game without valid login. </b>" + "<br>")
