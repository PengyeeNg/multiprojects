...
class CasinoSBOModule(Base_Setup.BSetup):

    def test_TC_CasinoSBO_01_Navigate_to_SBO_BeforeLogin(self):
        ...
        ProvidersActions.Access_to_CasinoSBO_Page(self)
        ProvidersActions.Click_on_CasinoSBO_Game(self)
        time.sleep(2)
        ProvidersActions.Assert_Login_Page(self)

    def test_TC_CasinoSBO_02_Navigate_to_SBO_AfterLogin(self):
    ...
    def test_TC_CasinoSBO_03_Enter_Game(self):
    ...
    def test_TC_CasinoSBO_04_Quick_Transfer(self):
