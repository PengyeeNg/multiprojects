...
class CasinoBIGModule(Base_Setup.BSetup):

    def test_TC_CasinoBIG_01_Navigate_to_BIG_BeforeLogin(self):
    ...
    def test_TC_CasinoBIG_03_Enter_Game(self):
    ...
    def test_TC_CasinoBIG_04_Quick_Transfer(self):
