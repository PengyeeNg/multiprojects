...
class Promotion_Statistic(SetUp.Base_SetUp.BSetUp):

    def test_TC_Promotion_Statistic_01_Add_Promotion(self):
    ...
    def test_TC_Promotion_Statistic_02_Edit_Promotion(self):
        Promotion_Statistic_Actions.Navigate_Promotion_Statistic(self)
    ...
    def test_test_Promotion_Statistic_03_Delete_Promotion(self):
        Promotion_Statistic_Actions.Navigate_Promotion_Statistic(self)
        print("<li>" + "Click on edit icon" + "</li>" + "<br>")
    ...
    def test_TC_Promotion_Statistic_04_Search_Promotion(self):
        Promotion_Statistic_Actions.Navigate_Promotion_Statistic(self)
    ...
    def test_TC_Promotion_Statistic_05_Table_Sorting_Promotion(self):
        Promotion_Statistic_Actions.Navigate_Promotion_Statistic(self)
    ...
    def test_TC_Promotion_Statistic_06_View_All_Deposit_Bonus_Strategy(self):
        Promotion_Statistic_Actions.Navigate_Promotion_Statistic(self)
    ...
    def test_TC_Promotion_Statistic_07_Navigate_Back_from_Add_Promotion_Page(self):
        Promotion_Statistic_Actions.Navigate_Promotion_Statistic(self)
        print("<li>" + "Click on add icon" + "</li>" + "<br>")
        self.driver.find_element_by_class_name(List_Promotion_Element.add_promotion_button).click()
        # Wait till page load
    ...
    def test_TC_Promotion_Statistic_08_Navigate_Back_from_Edit_Promotion_Page(self):
        Promotion_Statistic_Actions.Navigate_Promotion_Statistic(self)
        print("<li>" + "Click on edit icon" + "</li>" + "<br>")
        self.driver.find_element_by_class_name(List_Promotion_Element.edit_promotion_button).click()
        # Wait till page load
