...
class Merchant_Win_Loss(SetUp.Base_SetUp.BSetUp):

    def test_TC_Merchant_Win_Loss_01_Filter_Merchant_Win_Loss_Report(self):
        ...
        self.assertEqual(no_break_page, "Merchant Win/Loss Report", "Page breaks after clicking Search button.")
        print("Expected Results: Page does not break after clicking Search button." + "<br>")

    def test_TC_Merchant_Win_Loss_02_Reset_Filter_Merchant_Win_Loss_Report(self):
        Merchant_Win_Loss_Actions.Navigate_Merchant_Win_loss(self)
        print("<li>" + "Select Range- Today" + "</li>" + "<br>")
        self.driver.find_element_by_class_name(Report_Element.range_today_button).click()
