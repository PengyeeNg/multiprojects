...
class M8_Betting_Record(SetUp.Base_SetUp.BSetUp):

    def test_TC_M8_Bet_01_Filter_M8_Bet(self):
        M8_Actions.Navigate_M8(self)
        print("<li>" + "Insert Member Name" + "</li>" + "<br>")
        self.driver.find_element_by_id(Betting_Record_M8_Betting_Record_Element.member_name_filter_field).send_keys(Report_Data.member_name_filter)
    ...
    def test_TC_M8_Bet_02_Reset_Filter_M8_Bet(self):
        M8_Actions.Navigate_M8(self)
        print("<li>" + "Insert Member Name" + "</li>" + "<br>")
        self.driver.find_element_by_id(Betting_Record_M8_Betting_Record_Element.member_name_filter_field).send_keys(Report_Data.member_name_filter)
        ...
        empty_member_name_field = self.driver.find_element_by_id(Betting_Record_M8_Betting_Record_Element.member_name_filter_field).text
    ...
    def test_TC_M8_Bet_03_View_All_M8_Bet(self):
        M8_Actions.Navigate_M8(self)
        Betting_Record_Actions.View_All(self)

    def test_TC_M8_Bet_04_Table_Sorting_M8(self):
        M8_Actions.Navigate_M8(self)
        print("<li>" + "Click on User ID header" + "</li>" + "<br>")
        self.driver.find_element_by_xpath(Betting_Record_M8_Betting_Record_Element.user_id_header_sorting).click()
        self.driver.implicitly_wait(30)
        print("<li>" + "Click on Valid Amount header" + "</li>" + "<br>")
        self.driver.find_element_by_xpath(Betting_Record_M8_Betting_Record_Element.valid_amount_header_sorting).click()
        self.driver.implicitly_wait(30)
        print("<li>" + "Click on Win/Lose header" + "</li>" + "<br>")
        self.driver.find_element_by_xpath(Betting_Record_M8_Betting_Record_Element.win_loss_header_sorting).click()
        self.driver.implicitly_wait(30)
        print("<li>" + "Click on Bet Time header" + "</li>" + "<br>")
        self.driver.find_element_by_xpath(Betting_Record_M8_Betting_Record_Element.bet_time_header_sorting).click()
        self.driver.implicitly_wait(30)
        # Assert
        no_break_page = self.driver.title
        self.assertEqual(no_break_page, "M8", "Page breaks after clicking table sorting.")
