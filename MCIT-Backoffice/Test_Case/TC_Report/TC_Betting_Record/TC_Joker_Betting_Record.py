...
class Joker_Betting_Record(SetUp.Base_SetUp.BSetUp):

    def test_TC_Joker_Bet_01_Filter_Joker_Bet(self):
        Joker_Actions.Navigate_Joker(self)
        print("<li>" + "Insert Member Name" + "</li>" + "<br>")
        self.driver.find_element_by_id(Betting_Record_Joker_Betting_Record_Element.member_name_filter_field).send_keys(Report_Data.member_name_filter)
    ...
    def test_TC_Joker_Bet_02_Reset_Filter_Joker_Bet(self):
        Joker_Actions.Navigate_Joker(self)
        print("<li>" + "Insert Member Name" + "</li>" + "<br>")
        self.driver.find_element_by_id(Betting_Record_Joker_Betting_Record_Element.member_name_filter_field).send_keys(Report_Data.member_name_filter)
        ...
        empty_member_name_field = self.driver.find_element_by_id(Betting_Record_Joker_Betting_Record_Element.member_name_filter_field).text
    ...
    def test_TC_Joker_Bet_03_View_All_Joker_Bet(self):
        Joker_Actions.Navigate_Joker(self)
        Betting_Record_Actions.View_All(self)

    def test_TC_Joker_Bet_04_Table_Sorting_Joker(self):
        Joker_Actions.Navigate_Joker(self)
        print("<li>" + "Click on Username header" + "</li>" + "<br>")
        self.driver.find_element_by_xpath(Betting_Record_Joker_Betting_Record_Element.username_header_sorting).click()
        self.driver.implicitly_wait(30)
        print("<li>" + "Click on Bet Amount header" + "</li>" + "<br>")
        self.driver.find_element_by_xpath(Betting_Record_Joker_Betting_Record_Element.bet_amount_header_sorting).click()
        self.driver.implicitly_wait(30)
        print("<li>" + "Click on Player Win/Lose header" + "</li>" + "<br>")
        self.driver.find_element_by_xpath(Betting_Record_Joker_Betting_Record_Element.player_win_loss_header_sorting).click()
        self.driver.implicitly_wait(30)
        print("<li>" + "Click on Bet Time header" + "</li>" + "<br>")
        self.driver.find_element_by_xpath(Betting_Record_Joker_Betting_Record_Element.bet_time_header_sorting).click()
        self.driver.implicitly_wait(30)
        # Assert
        no_break_page = self.driver.title
        self.assertEqual(no_break_page, "Joker", "Page breaks after clicking table sorting.")
